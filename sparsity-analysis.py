...
for i, sparsity in enumerate(sparsities):
    ...
    print("SNN:")
    print(f"\t- Total energy: {snn_energy['tot'][i]/1e6:.2f} mJ.")
    print(f"\t- Memory energy: {snn_energy['mem'][i]/1e6:.2f} mJ.")
    print(f"\t- Computations energy: {snn_energy['comp'][i]/1e6:.2f} mJ.")
    print("ANN:")
    print(f"\t- Total energy: {ann_energy['tot'][i]/1e6:.2f} mJ.")
    print(f"\t- Memory energy: {ann_energy['mem'][i]/1e6:.2f} mJ.")
    print(f"\t- Computations energy: {ann_energy['comp'][i]/1e6:.2f} mJ.")
